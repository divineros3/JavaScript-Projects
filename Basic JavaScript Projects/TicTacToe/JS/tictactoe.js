...
function placeXOrO(squareNumber) {
    //Thise condition ensures a square hasn't been selected already.
    //The .some() method is used to check each element of the selectSquare array to see if it contains the square numnber clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrueves the HTML element id that was clicked.
        ...
        if (activePlayer === "X") {
            ...
            //If activePlayer is equal to "O", the o.png id placed in HTML
        ...
        checkWinConditions();
        //This condtition id for changing the active player.
        if (activePlayer === "X") {
