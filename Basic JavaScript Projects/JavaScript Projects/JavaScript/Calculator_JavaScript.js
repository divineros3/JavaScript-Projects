...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second_Operand is true and ssets Display_Value to the key that was clicked on.
    if (Wait_Second_Operand === true) {
        Calculator.Display_Value = digit;
        Calculator.Wait_Second_Operand = false;
    } else {
        //This overwrites Display_Value if the current valuse is 0, otherwise it adds onto it.
